...
\usepackage[backref=true,backend=biber,style=authoryear,sorting=none,hyperref=true]{biblatex} %Literaturverzeichnis Harvard Style und \parencite verwenden
...
\renewcommand*{\arraystretch}{1.1} %höhere Zeilen in tabellen
...
\ihead{\textbf{Regenerative Energietechnik\\Kraftwerksreserven Deutschland}\\\footnotesize{Moritz Deckert, Fynn Linnenbrügger}}
\ohead{\includegraphics[height=15mm]{bilder/ostfalia.png}} %Logo Kopfzeile
...
\setcounter{page}{0}	
\include{01_deckblatt.tex}
\include{02_verzeichnisse.tex}
