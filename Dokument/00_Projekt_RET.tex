...
\usepackage[backref=true,backend=biber,style=authoryear,sorting=none,hyperref=true,maxcitenames=2]{biblatex} %Literaturverzeichnis Harvard Style und \parencite verwenden
