\section{Aktuelle Bewertung der Kraftwerksreserven zur Frequenzstabilisierung und Reserveleistungsvorhaltung} \label{sect: Aktuelle Bewertung der Kraftwerksreserven zur Frequenzstabilisierung und Reserveleistungsvorhaltung}
	...
	\subsection{Bewertung der logistischen Situation der Reserven}
		...
		\subsubsection{Logistischer Stand des Mineralöls}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[page=1, width=0.5\textwidth]{./anhang/Ölreserve.png}
...
\section{Die zukünftige Entwicklung von Kraftwerksreserven}
	...
	Ohne Reduzierung der \COO-Emissionen weltweit ist das \COO-Budget zur Einhaltung des 1,5 Grad Ziels in 6 Jahren und 8 Monaten erschöpft (Stand November 2022).
	...
	In den folgenden Abschnitten werden mithilfe von zwei Studien mögliche Energieversorgungsstrukturen für die Jahre 2030 und 2045 aufgezeigt.
...
%		Die heute schon viel verwendete Wasserkraft wird dabei auch zukünftig zur Verfügung stehen. (\textbf{Würde ich wegen Kapitel 4.4 evtl weglassen!!}) \\
		...
		\begin{figure} [H]
			...
			\includegraphics[page=33,trim=45 380 25 170, clip, width=0.9\textwidth]{./anhang/Agora Studie.pdf}
...
%		Grundlage für Stromerzeugung und -verbrauch bot das Wetterjahr 2012. Dieses zeichnet sich speziell durch eine lange Kälteperiode und niedrige Erträge aus Windkraft aus. Damit soll indirekt auch die Versorgungssicherheit betrachtet werden.\cite[S.2]{ESRa_Fraunhofer}} \\
	...
	\subsection{Vergleich der Studien im Hinblick auf die Entwicklung der Kraftwerksreserven} \label{sect: Vergleich der Studien im Hinblick auf die Entwicklung der Kraftwerksreserven}
